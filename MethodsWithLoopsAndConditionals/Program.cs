...
namespace MethodsExercise3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var userInput = "This is getting hard";
            int age = 39;
            bool proceed = false;
            ...
            do
            {
                ...
                Console.WriteLine($"What is your age and show me your ID!");
        ...
        {
            Console.WriteLine($"Can you count that high?");
        ...
        public static bool OfVotingAge(int age)
        {
            if (age >= 18)
            {
                Console.WriteLine($"You made the requirements");
                return true;
            }
            else
            {
        ...
        public static void EvenOrOdd(int number)
        {
            if (number % 2 == 0)
            {
                Console.WriteLine($"Looks like even");
            }
            else
            {
